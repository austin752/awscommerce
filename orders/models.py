...
from awscommerce.utils import unique_order_id_generator
...
class Order(models.Model):
	...
	billing_profile = models.CharField(max_length=120, blank=True)
	shipping_address = models.CharField(max_length=120, blank=True)
	billing_address = models.CharField(max_length=120, blank=True)
