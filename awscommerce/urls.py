...
urlpatterns = [
    ...
    #url(r'^billing/payment/method/', payment_method_view,  name='payment_method_view'),
    #url(r'^payment/method/create/', payment_method_create_view, name='payment_method_create'),
